...
class TriageIssue:
    ...
    def update_self(self, jira_issue: JiraIssue, jira_project: JiraProject) -> None:
        assert jira_issue is not None, "Got null JiraIssue in update_self. No Good."
        ...
        self._data[self.reviewer_index] = TriageIssue._sanitize(jira_issue[self.reviewer_field])
